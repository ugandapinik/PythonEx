...
def graph_data(stock):
    ...
    ax1.plot_date(date[-start:], h_l[-start:], '-', linewidth=1, label="H-L")
    ...
    ax2v.plot([],[], color="#0079a3", alpha=0.4, label='Volume', linewidth=2)
    ...
    # ax2v legend
    ax2v.legend()
    leg = ax2v.legend(loc=4, ncol=2, prop={'size': 8})
    leg.get_frame().set_alpha(0.4)
